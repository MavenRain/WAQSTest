...
using WAQSTest.ClientContext.Fault;
using WAQSTest.ClientContext.Interfaces;
using WAQSTest.ClientContext.Interfaces.Errors;
...
namespace WAQSTest.ClientContext
{
    public partial class WAQSModelClientContext : WAQSModelClientContextBase, IWAQSModelClientContext, IClientContext
    {
        ...
        private Dictionary<Entity1Keys, WAQSTest.Entity1> _entity1Dico;
        private Dictionary<Entity1Keys, WAQSTest.Entity1> Entity1Dico
        {
            get { return _entity1Dico ?? (_entity1Dico = new Dictionary<Entity1Keys, WAQSTest.Entity1>()); }
        }
    
        private Dictionary<Guid, WAQSTest.Entity1> _entity1DataTransferDico;
        private Dictionary<Guid, WAQSTest.Entity1> Entity1DataTransferDico
        {
            get { return _entity1DataTransferDico ?? (_entity1DataTransferDico = new Dictionary<Guid, WAQSTest.Entity1>()); }
        }
    
        private Dictionary<string, WAQSTest.Entity1> _entity1AddedDico;
        private Dictionary<string, WAQSTest.Entity1> Entity1AddedDico
        {
            get { return _entity1AddedDico ?? (_entity1AddedDico = new Dictionary<string, WAQSTest.Entity1>()); }
        }
        private void AddEntity1AddedDico(WAQSTest.Entity1 entity)
        {
            Entity1AddedDico.Add(entity.EntityKey, entity);
            entity.EntityKeyChanged += ResetEntityKey;
        }
        private void RemoveEntity1AddedDico(WAQSTest.Entity1 entity)
        {
            Entity1AddedDico.Remove(entity.EntityKey);
            entity.EntityKeyChanged -= ResetEntityKey;
        }
    
        private void ResetEntityKey(WAQSTest.Entity1 entity, string oldEntityKey)
        {
        ...
        public IClientEntitySet<IWAQSModelClientContext, WAQSTest.Entity1> Entity1 
        { 
            get { return Entity1Internal; }
        }
        private ClientEntitySet<IWAQSModelClientContext, WAQSTest.Entity1> Entity1Internal
        {
            get
            {
                if (_entity1 == null)
                {
                    _entity1 = new ClientEntitySet<IWAQSModelClientContext, WAQSTest.Entity1>("Entity1", this, e => new Entity1Keys { Id = e.Id });
        ...
        private ClientEntitySet<IWAQSModelClientContext, WAQSTest.Entity1> _entity1;
    
        private void EntityAddedOrAttached(WAQSTest.Entity1 entity)
        {
            ...
            if (entity.HasTemporaryKey)
            {
                WAQSTest.Entity1 entityInAddedDico;
        ...
        private void EntityReplaced(WAQSTest.Entity1 entityInEntitySet, WAQSTest.Entity1 entity)
        {
            EntityReplacedInternal(entityInEntitySet, entity);
        }
        private void EntityReplacedInternal(WAQSTest.Entity1 entityInEntitySet, WAQSTest.Entity1 entity)
        {
        ...
        private void EntityDetached(WAQSTest.Entity1 entity)
        {
        ...
        private void EntityAttachWithoutChangingStateSubEntities(WAQSTest.Entity1 entity)
        {
        ...
        private void EntityAttachWithoutChangingStateSubEntitiesBody(WAQSTest.Entity1 entity, WAQSTest.Entity1 entityInCache)
        {
            if (entity == entityInCache)
                return;
        }
    
        private WAQSTest.Entity1 GetEntityInCache(WAQSTest.Entity1 entity, bool includingDeleted = false, bool applyDataTransfer = false)
        {
            if (entity == null)
                return null;
            WAQSTest.Entity1 value;
        ...
        protected override WAQSTest.Entity1 GetEntity(WAQSTest.Entity1 entity, bool applyState, MergeOption? mergeOption = null, bool applyDataTransfer = false)
        {
            return GetEntity(entity, applyState, mergeOption, true, applyDataTransfer: applyDataTransfer);
        }
        private WAQSTest.Entity1 GetEntity(WAQSTest.Entity1 entity, bool applyState, MergeOption? mergeOption = null, bool includingDeleted = false, ObjectState defaultState = ObjectState.Unchanged, bool applyDataTransfer = false)
        {
            if (entity == null)
                return null;
            object entityGot;
            if (EntitiesGot.TryGetValue(entity, out entityGot))
                return (WAQSTest.Entity1)entityGot;
        ...
        private WAQSTest.Entity1 AttachWithoutChangingState(WAQSTest.Entity1 entity, ObjectState? defaultState = null)
        {
            if (Entity1Internal.Contains(entity))
                return entity;
        ...
        public void RefreshNewLoadedProperties(WAQSTest.Entity1 entityInCache, WAQSTest.Entity1 entity, bool applyState = false)
        {
        ...
        public void RefreshCurrentValues(WAQSTest.Entity1 entityInCache, WAQSTest.Entity1 entity)
        {
            RefreshCurrentValues(entityInCache, entity, false);
        }
        public void RefreshCurrentValues(WAQSTest.Entity1 entityInCache, WAQSTest.Entity1 entity, bool applyState = false)
        {
            bool isDeserializing = entityInCache.IsDeserializing;
            entityInCache.IsDeserializing = true;
        ...
        private void RefreshOriginalValues(WAQSTest.Entity1 entityInCache, WAQSTest.Entity1 entity)
        {
        ...
        private WAQSTest.Entity1 ReduceToKey(WAQSTest.Entity1 entity)
        {
            WAQSTest.Entity1 value = new WAQSTest.Entity1 { Id = entity.Id };
            return value;
        }
    
        private WAQSTest.Entity1 ReduceToModifications(WAQSTest.Entity1 entity)
        {
            WAQSTest.Entity1 value = new WAQSTest.Entity1 { Id = entity.Id };
        ...
        private void ReduceNavigationProperties(WAQSTest.Entity1 originalValue, WAQSTest.Entity1 newValue)
        {
        ...
        private void RefreshComputedValues(WAQSTest.Entity1 entity, WAQSTest.Entity1 dbEntity)
        {
            if (entity.HasTemporaryKey)
            {
        ...
        public WAQSModelSerializableContext GetModifiedEntities()
        {
            ...
            { 
    			Entity1 = 
                    new List<WAQSTest.Entity1>(from e in Entity1Internal.AllEntities
        ...
        {
            if (typeof(T) == typeof(WAQSTest.Entity1))
        ...
        public WAQSModelSerializableContext GetSerializableContext(WAQSModelSerializableContext modifiedEntities)
        {
    		...
    		var reducedEntity1Dictionary = new Dictionary<WAQSTest.Entity1, WAQSTest.Entity1>();
        ...
        private object GetEntity(object entity, bool applyState, ObjectState defaultState = ObjectState.Unchanged, bool applyDataTransfer = false)
        {
            ...
            if (EntitiesGot.TryGetValue(entity, out entityGot))
                return entityGot;
            var entityAsEntity1 = entity as WAQSTest.Entity1;
        ...
        private class WAQSModelClientContextNoTracking : WAQSModelClientContextBase
        {
            ...
            private Dictionary<Entity1Keys, WAQSTest.Entity1> Entity1
            {
                get { return _entity1 ?? (_entity1 = new Dictionary<Entity1Keys, WAQSTest.Entity1>()); }
            }
            private Dictionary<Entity1Keys, WAQSTest.Entity1> _entity1;
            ...
            protected override WAQSTest.Entity1 GetEntity(WAQSTest.Entity1 entity, bool applyState, MergeOption? mergeOption = null, bool applyDataTransfer = false)
            {
                ...
                WAQSTest.Entity1 entityInCache;

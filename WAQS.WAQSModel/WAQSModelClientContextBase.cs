...
using WAQSTest.ClientContext.QueryResult;
...
namespace WAQSTest.ClientContext
{
    public abstract partial class WAQSModelClientContextBase : IClientContextBase
    {
        ...
        public string Name 
        { 
            get { return "WAQSTest.ClientContext.WAQSModelClientContext"; } 
        }
    
        protected Func<WAQSTest.ClientContext.ServiceReference.IWAQSModelService> ServiceFactory { get; private set; }
        ...
        protected abstract WAQSTest.Entity1 GetEntity(WAQSTest.Entity1 entity, bool applyState, MergeOption? mergeOption = null, bool applyDataTransfer = false);
        ...
        protected virtual object InstanciateAndAttach(IAsyncQueryableBase query, WAQSModelQueryResult queryResult, MergeOption mergeOption)
        {
            ...
            getEntity = (value, type) =>
                {
                    WAQSTest.Entity1 valueAsEntity1;
                    if ((valueAsEntity1 = (value as WAQSTest.Entity1)) != null)
                        return GetEntity(valueAsEntity1, false, mergeOption);
                    var valueAsEntity1s = value as IEnumerable<WAQSTest.Entity1>;
                    if (valueAsEntity1s != null)
                    {
                        var ctor = value.GetType().GetConstructor(new Type[] { typeof(IEnumerable<WAQSTest.Entity1>) });
                        if (ctor != null)
                        ...
                        if (type == typeof(TrackableCollection<WAQSTest.Entity1>))
                            return new TrackableCollection<WAQSTest.Entity1>(valueAsEntity1s);

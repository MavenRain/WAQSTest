...
namespace WpfApplication1.ClientContext.QueryResult
{
    ...
    [KnownType(typeof(TimeSpan?[]))]
    [KnownType(typeof(string[]))]
    [KnownType(typeof(WpfApplication1.Entity1))]
    [KnownType(typeof(WpfApplication1.Entity1[]))]
    public partial class WAQSModelQueryResult : WCFAsyncQueryableServices.ClientContext.QueryResult.QueryResult
    {
        [DataMember]
